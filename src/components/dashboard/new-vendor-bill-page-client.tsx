...
export default function NewVendorBillPageClient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await vendorBillsAPI.create(businessId, { vendorId, billNumber: billNumber || undefined, billDate, dueDate: dueDate || undefined, currency, notes, items: validItems, subtotal, taxAmount: tax, totalAmount: total })
