...
export function EditExpenseClient({ businessId, expenseId }: { businessId: string, expenseId: string }) {
    ...
    <div className="flex flex-col gap-6 w-full max-w-3xl mx-auto pb-24 pt-4 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          <h1 className="text-3xl font-bold text-foreground tracking-tight">Edit Expense</h1>
