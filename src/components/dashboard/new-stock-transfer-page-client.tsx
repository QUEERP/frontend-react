...
export default function NewStockTransferPageClient() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (prdRes.status === 'fulfilled') setProducts(prdRes.value.products || prdRes.value.data || [])
    } catch {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await stockAPI.createTransfer(businessId, { fromWarehouseId, toWarehouseId, transferDate, notes, items: validItems })
