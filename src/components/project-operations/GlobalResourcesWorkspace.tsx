  ...
  const filteredResources = useMemo(() => {
    return resources.filter(res => {
      ...
      const matchesSearch = 
        ...
        (res.projectNames || []).some((p: string) => p.toLowerCase().includes(searchLower));
      ...
      if (filters['Project'] && !(res.projectNames || []).includes(filters['Project'])) return false;
            ...
            <div className="p-4 space-y-4 flex-1 overflow-y-auto">
              ...
              <div>
                ...
                >
                  ...
                  {Array.from(new Set(resources.flatMap(r => r.projectNames || []))).map(p => (
