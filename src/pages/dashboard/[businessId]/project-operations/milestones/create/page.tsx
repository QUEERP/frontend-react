        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <Section title="3. Assignment" icon={Users}>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                <Field label="Owner">
                  <UserSelect businessId={businessId} value={form.ownerId} onChange={(v) => set('ownerId', v)} />
                </Field>
                <Field label="Project Manager">
                  <UserSelect businessId={businessId} value={form.projectManagerId} onChange={(v) => set('projectManagerId', v)} placeholder="Select Manager" />
                </Field>
                <Field label="Approver">
                  <UserSelect businessId={businessId} value={form.approverId} onChange={(v) => set('approverId', v)} placeholder="Select Approver" />
                </Field>
