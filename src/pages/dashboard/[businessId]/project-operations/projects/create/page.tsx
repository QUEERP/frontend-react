...
export default function CreateProjectPage() {
  ...
  if (business?.businessType?.toLowerCase() === 'construction') {
    return <ConstructionProjectForm businessId={businessId} />;
  }
    ...
    const loadAllData = async () => {
      try {
        ...
        if (contractId) {
          ...
          const res = await contractsAPI.getContractById(businessId, contractId);
            ...
            <SectionCard title="General Information" icon={Briefcase}>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative flex items-center">
                    <UserSelect businessId={businessId} value={formData.projManager} onChange={(v) => handleChange('projManager', v)} placeholder="Select Project Manager..." />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative flex items-center">
                    <UserSelect businessId={businessId} value={formData.projSponsor} onChange={(v) => handleChange('projSponsor', v)} placeholder="Select Sponsor..." />
                  </div>
                </div>
              </div>
            </SectionCard>
