            ...
            <SectionCard title="3. Resource Allocation" icon={Users}>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="space-y-1.5">
                  ...
                  <div className="relative flex items-center">
                    <UserSelect businessId={businessId as string} value={formData.projectManager} onChange={(v) => handleChange('projectManager', v)} placeholder="Select Manager..." />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative flex items-center">
                    <UserSelect businessId={businessId as string} value={formData.taskOwner} onChange={(v) => handleChange('taskOwner', v)} placeholder="Select Owner..." />
                  </div>
                </div>
