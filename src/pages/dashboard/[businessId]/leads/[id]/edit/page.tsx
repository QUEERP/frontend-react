      ...
      try {
        ...
        if (response.success) {
          ...
          setFormData({
            ...
            tags: leadData.tags || [],
            leadValue: leadData.leadValue ?? ('' as unknown as number),
  ...
  return (
    <div className="flex min-h-svh w-full flex-col gap-6 bg-[#f8fafc] px-4 pb-12 pt-6 sm:px-6 lg:px-8">
      ...
      <div className="flex items-center gap-4 mb-2">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Edit Lead</h1>
          <p className="text-sm text-slate-500 mt-0.5">Update lead information</p>
        </div>
      </div>
